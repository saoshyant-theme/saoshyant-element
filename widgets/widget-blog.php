...
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if( ! class_exists( 'ssel_widget_blog' ) ) {

add_action( 'widgets_init', 'ssel_register_widget_blog' );
function ssel_register_widget_blog() {
    register_widget( 'ssel_widget_blog' );
}

class ssel_widget_blog extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'ssel_blog',
			 esc_html__('Beyond','ssel').' - '. esc_html__('Blog', 'ssel') 
		);
	}
 	...
 	public  function option(){
		...
		$option[]= array( 
				"name"			=> esc_html__('Show Comments Meta','ssel'),
				"id"			=> "meta_comments",
				"type"			=> "checkbox",
		);	
	 /**********************Layout************************/
    ...
    /**********  The widget For Display *******/
 	public function widget( $args, $instance ) {
		...
		$args['option'] =array(
			...
			'ratio' => !empty( $instance['ratio'] ) ? $instance['ratio'] : 'rd-ratio-auto',
		...
		<div id="<?php echo esc_attr($widget_id) ?>" class="rd-element-blog_1 rd-widget-post rd-element-item rd-auto-width">
		 <?php 	echo ssel_blog_config($args, true);?>
		</div>
	<?php 
