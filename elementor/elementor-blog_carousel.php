<?php
  if( ! class_exists( 'ssel_element_blog_carousel' ) ) {
class ssel_element_blog_carousel extends \Elementor\Widget_Base {

 
	public function get_name() {
		return 'ssel_blog_carousel';
	}

 
	public function get_title() {
		return __( 'نوشته های چرخشی', 'ssel' );
	}
...
protected function _register_controls() {
	...
	protected function render() {
 	...
 	$args['option'] = array(
  		...
  		echo '<aside class=" rd-elementor-item sao-element-blog_carousel">';       
  		echo ssel_blog_carousel_config($args,true,true);
		echo '</aside>';
