<?php
  if( ! class_exists( 'ssel_element_portfolio_masonry' ) ) {
class ssel_element_portfolio_masonry extends \Elementor\Widget_Base {

 
	public function get_name() {
		return 'ssel_portfolio_masonry';
	}

 
	public function get_title() {
		return __( 'نمونه کار ها - ماسونری', 'ssel' );
	}
	...
	protected function render() {
		...
		$args['key']= $this->get_id();
 		...
 		$args['option'] = array(
  		...
  		echo ssel_blog_masonry_config($args, true,true);
		echo '</aside>'; 
