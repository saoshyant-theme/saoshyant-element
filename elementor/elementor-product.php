<?php
  if( ! class_exists( 'ssel_element_product' ) ) {
class ssel_element_product extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		$args['key']= $this->get_id();
 		...
 		$args['option'] = array(
  		...
  		echo '<aside class="  rd-elementor-item sao-element-product">';       
  		echo ssel_product_config($args, true,true);
		echo '</aside>'; 
