<?php
  if( ! class_exists( 'ssel_element_portfolio' ) ) {
class ssel_element_portfolio extends \Elementor\Widget_Base {

 
	public function get_name() {
		return 'ssel_portfolio';
	}

 
	public function get_title() {
		return __( 'نمونه کارها', 'ssel' );
	}
	...
	protected function render() {
		...
		$args['key']= $this->get_id();
 		...
 		$args['option'] = array(
  		...
  		echo ssel_portfolio_config($args, true,true);
		echo '</aside>'; 
