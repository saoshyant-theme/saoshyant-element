 ...
 */ 
  ...
  if( ! function_exists( 'ssel_fa_icon' ) ) {
 
function ssel_fa_icon( $element) {

$sao_icons =array(
	
	 'آیکون های برنامه وب' => array(
	...
	__('Transportation Icons','ssel')=> array(
	...
	'آیکون های پخش کننده ویدیو'=> array(
		'fa-arrows-alt' => 'arrows-alt',
...
add_filter('ssel_icon_element', 'ssel_fa_icon');
